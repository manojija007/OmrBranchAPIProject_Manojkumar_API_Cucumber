package com.omrbranch.pojo.changeprofilepicture;
...
public class Data {
    ...
    private String faq_set1_access;
    private String faq_set2_access;
    private String faq_set3_access;
    private String faq_set4_access;
